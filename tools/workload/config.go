...
func (c *WorkloadConfig) ParseFlags() error {
	...
	flag.StringVar(&c.WorkloadType, "workload-type", c.WorkloadType, "workload type: [bank, sysbench, large_row, shop_item, uuu, bank2, bank_update, crawler, dc, staging_forward_index]")
