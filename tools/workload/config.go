...
func (c *WorkloadConfig) ParseFlags() error {
	...
	flag.StringVar(&c.WorkloadType, "workload-type", c.WorkloadType, "workload type: [bank, sysbench, large_row, shop_item, shop2, shop3, uuu, bank2, bank3, bank_update, crawler, dc, wide_table_with_json]")
