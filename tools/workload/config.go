...
func (c *WorkloadConfig) ParseFlags() error {
	...
	flag.StringVar(&c.WorkloadType, "workload-type", c.WorkloadType, "workload type: [bank, sysbench, large_row, shop_item, uuu, bank2, bank3, bank_update, bis_batch_metadata, crawler, dc, wide_table_with_json]")
