...
require (
	...
	github.com/pingcap/tiflow v0.0.0-20260630180521-f90a1dd48658
...
replace github.com/IBM/sarama v1.41.2 => github.com/pingcap/sarama v1.41.2-pingcap-20260622.1
