...
// coordinator and describes the total dispatcher count for its capture node.
...
type EventBrokerDispatcherCountResponse struct {
	...
	// AssumedEmpty is true when no fresh report arrived within the bounded
	// wait period and the dispatcher count is treated as zero.
	AssumedEmpty bool `protobuf:"varint,6,opt,name=AssumedEmpty,proto3" json:"AssumedEmpty,omitempty"`
}
...
func (m *EventBrokerDispatcherCountResponse) GetAssumedEmpty() bool {
	if m != nil {
		return m.AssumedEmpty
	}
	return false
}
...
var fileDescriptor_a1db670929506a40 = []byte{
	...
	,
}
...
func (m *EventBrokerDispatcherCountResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AssumedEmpty", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
