...
func (h *intEventHandler) GetArea(path int, dest D) string       { return "" }
...
func prepareDynamicStream(pathCount int, eventCount int, times int) (DynamicStream[int, intEvent, D, *intEventHandler], *atomic.Int64, *sync.WaitGroup) {
	wg := &sync.WaitGroup{}
...
func runDynamicStream(ds DynamicStream[int, intEvent, D, *intEventHandler], pathCount int, eventCount int) {
