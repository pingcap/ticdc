...
var testCases = []testCase{
	// Test case with foreign key - foreign key references should be renamed together
	{
		...
		[][]*filter.Table{{&filter.Table{Schema: "test", Name: "t1"}, &filter.Table{Schema: "test", Name: "t2"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xtest", Name: "t1"}, &filter.Table{Schema: "xtest", Name: "t2"}}},
	...
	// CREATE SCHEMA/DATABASE
	{
		...
		[][]*filter.Table{{&filter.Table{Schema: "s1", Name: ""}}},
		[][]*filter.Table{{&filter.Table{Schema: "xs1", Name: ""}}},
	...
	// ALTER DATABASE without explicit name - cannot rename since AST doesn't store database name
	{
		...
		[][]*filter.Table{{&filter.Table{Schema: "test", Name: ""}}},
		[][]*filter.Table{{&filter.Table{Schema: "xtest", Name: ""}}},
	...
	// DROP TABLE - single table
	{
		...
		[][]*filter.Table{{&filter.Table{Schema: "Ss1", Name: "tT1"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xSs1", Name: "xtT1"}}},
	...
	// DROP TABLE - multiple tables (requires SplitDDL to split, so we test without splitting)
	{
		...
		[][]*filter.Table{{&filter.Table{Schema: "s1", Name: "t1"}, &filter.Table{Schema: "s2", Name: "t2"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xs1", Name: "xt1"}, &filter.Table{Schema: "xs2", Name: "xt2"}}},
		[]string{"DROP TABLE `xs1`.`xt1`, `xs2`.`xt2`"},
	},
	{
		"drop table `s1`.`t1`, `s2`.`t2`, `xx`",
		[]string{"DROP TABLE `s1`.`t1`, `s2`.`t2`, `xx`"},
		[][]*filter.Table{{&filter.Table{Schema: "s1", Name: "t1"}, &filter.Table{Schema: "s2", Name: "t2"}, &filter.Table{Schema: "test", Name: "xx"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xs1", Name: "xt1"}, &filter.Table{Schema: "xs2", Name: "xt2"}, &filter.Table{Schema: "xtest", Name: "xxx"}}},
	...
	// CREATE TABLE
	{
		...
		[][]*filter.Table{{&filter.Table{Schema: "s1", Name: "t1"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xs1", Name: "xt1"}}},
		[]string{"CREATE TABLE `xs1`.`xt1` (`id` INT)"},
	},
	{
		"create table `t1` (id int)",
		[]string{"CREATE TABLE `t1` (`id` INT)"},
		[][]*filter.Table{{&filter.Table{Schema: "test", Name: "t1"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xtest", Name: "xt1"}}},
		[]string{"CREATE TABLE `xtest`.`xt1` (`id` INT)"},
	},
	{
		"create table `s1` (c int default '0')",
		[]string{"CREATE TABLE `s1` (`c` INT DEFAULT '0')"},
		[][]*filter.Table{{&filter.Table{Schema: "test", Name: "s1"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xtest", Name: "xs1"}}},
	...
	// CREATE TABLE LIKE
	{
		...
		[][]*filter.Table{{&filter.Table{Schema: "test", Name: "t1"}, &filter.Table{Schema: "test", Name: "t2"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xtest", Name: "xt1"}, &filter.Table{Schema: "xtest", Name: "xt2"}}},
		[]string{"CREATE TABLE `xtest`.`xt1` LIKE `xtest`.`xt2`"},
	},
	{
		"create table `s1`.`t1` like `t2`",
		[]string{"CREATE TABLE `s1`.`t1` LIKE `t2`"},
		[][]*filter.Table{{&filter.Table{Schema: "s1", Name: "t1"}, &filter.Table{Schema: "test", Name: "t2"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xs1", Name: "xt1"}, &filter.Table{Schema: "xtest", Name: "xt2"}}},
		[]string{"CREATE TABLE `xs1`.`xt1` LIKE `xtest`.`xt2`"},
	},
	{
		"create table `t1` like `xx`.`t2`",
		[]string{"CREATE TABLE `t1` LIKE `xx`.`t2`"},
		[][]*filter.Table{{&filter.Table{Schema: "test", Name: "t1"}, &filter.Table{Schema: "xx", Name: "t2"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xtest", Name: "xt1"}, &filter.Table{Schema: "xxx", Name: "xt2"}}},
	...
	// RENAME TABLE - multiple (no splitting)
	{
		...
		[][]*filter.Table{{&filter.Table{Schema: "test", Name: "t1"}, &filter.Table{Schema: "test", Name: "t2"}, &filter.Table{Schema: "s1", Name: "t1"}, &filter.Table{Schema: "test", Name: "t2"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xtest", Name: "xt1"}, &filter.Table{Schema: "xtest", Name: "xt2"}, &filter.Table{Schema: "xs1", Name: "xt1"}, &filter.Table{Schema: "xtest", Name: "xt2"}}},
	...
	},
	{
		...
		[][]*filter.Table{{&filter.Table{Schema: "s1", Name: "t1"}, &filter.Table{Schema: "xx", Name: "t2"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xs1", Name: "xt1"}, &filter.Table{Schema: "xxx", Name: "xt2"}}},
	...
	// ALTER TABLE ADD COLUMN with multiple columns (no splitting)
	{
		...
		[][]*filter.Table{{&filter.Table{Schema: "test", Name: "t1"}}},
		[][]*filter.Table{{&filter.Table{Schema: "xtest", Name: "t1"}}},
