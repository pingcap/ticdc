...
var (
	// CloudStorageFileCount records the number of files generated by cloud storage sink.
	CloudStorageFileCount = prometheus.NewCounterVec(prometheus.CounterOpts{
		Namespace: namespace,
		Subsystem: subsystem,
...
func InitCloudStorageMetrics(registry *prometheus.Registry) {
	registry.MustRegister(CloudStorageFileCount)
