...
func TestRedoSinkInProcessor(t *testing.T) {
	...
	testWriteDMLs := func(storage string, useFileBackend bool) {
		...
		dmlMgr := New(ctx, common.NewChangeFeedIDWithName("test", common.DefaultKeyspaceNamme), cfg)
...
func TestRedoSinkError(t *testing.T) {
	...
	logMgr := New(ctx, common.NewChangeFeedIDWithName("test", common.DefaultKeyspaceNamme), cfg)
