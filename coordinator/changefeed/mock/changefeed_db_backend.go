...
func (m *MockBackend) ResumeChangefeed(ctx context.Context, id common.ChangeFeedID, newCheckpointTs uint64, syncPointGuardTs uint64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResumeChangefeed", ctx, id, newCheckpointTs, syncPointGuardTs)
	ret0, _ := ret[0].(error)
	return ret0
}

// ResumeChangefeed indicates an expected call of ResumeChangefeed.
func (mr *MockBackendMockRecorder) ResumeChangefeed(ctx, id, newCheckpointTs, syncPointGuardTs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResumeChangefeed", reflect.TypeOf((*MockBackend)(nil).ResumeChangefeed), ctx, id, newCheckpointTs, syncPointGuardTs)
}
