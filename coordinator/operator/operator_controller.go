...
// CountOperatorsInvolvingNode returns the number of in-flight operators that may
// affect the given node.
//
// It is used by node drain logic to determine whether it is safe to advance a node
