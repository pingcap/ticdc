...
func (h *OpenAPIV2) MoveTable(c *gin.Context) {
	...
	dispatcherType, _ := strconv.ParseInt(c.Query("dispatcherType"), 10, 64)
	err = maintainer.MoveTable(int64(tableId), node.ID(targetNodeID), dispatcherType)
	if err != nil {
...
func (h *OpenAPIV2) MoveSplitTable(c *gin.Context) {
	...
	targetNodeID := c.Query("targetNodeID")
	dispatcherType, _ := strconv.ParseInt(c.Query("dispatcherType"), 10, 64)
	err = maintainer.MoveSplitTable(int64(tableId), node.ID(targetNodeID), dispatcherType)
	if err != nil {
...
func (h *OpenAPIV2) SplitTableByRegionCount(c *gin.Context) {
	...
	dispatcherType, _ := strconv.ParseInt(c.Query("dispatcherType"), 10, 64)
	err = maintainer.SplitTableByRegionCount(int64(tableId), dispatcherType)
	if err != nil {
...
func (h *OpenAPIV2) MergeTable(c *gin.Context) {
	...
	dispatcherType, _ := strconv.ParseInt(c.Query("dispatcherType"), 10, 64)
	err = maintainer.MergeTable(int64(tableId), dispatcherType)
	if err != nil {
...
func (h *OpenAPIV2) ListTables(c *gin.Context) {
	...
	dispatcherType, _ := strconv.ParseInt(c.Query("dispatcherType"), 10, 64)
	tables := maintainer.GetTables(dispatcherType)
...
func (h *OpenAPIV2) getDispatcherCount(c *gin.Context) {
	...
	dispatcherType, _ := strconv.ParseInt(c.Query("dispatcherType"), 10, 64)
	number := maintainer.GetDispatcherCount(dispatcherType)
