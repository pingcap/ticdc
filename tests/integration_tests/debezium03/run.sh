...
cdc_cli_changefeed create -c test --sink-uri="kafka://127.0.0.1:9092/output_ticdc?protocol=debezium&kafka-version=2.4.0&debezium-binary-handling-mode=hex&debezium-decimal-handling-mode=string&debezium-bigint-unsigned-handling-mode=long" --config "$CUR/changefeed.toml"
