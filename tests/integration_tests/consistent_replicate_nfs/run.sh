...
function run() {
	...
	cdc redo apply --tmp-dir="$tmp_download_path/apply" --storage="$storage_path" -c=$changefeed_id --log-level="debug" --sink-uri="mysql://normal:123456@127.0.0.1:3306/" >$WORK_DIR/cdc_redo.log
