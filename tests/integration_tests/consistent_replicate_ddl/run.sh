...
function run() {
	...
	export GO_FAILPOINTS='github.com/pingcap/ticdc/downstreamadapter/sink/mysql/MySQLSinkHangLongTime=1*return(true);github.com/pingcap/ticdc/pkg/sink/mysql/mysql_writer_ddl/MySQLSinkExecDDLDelay=return(true)'
