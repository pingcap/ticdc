...
If you need to specify a version, os or arch, you can use, for example: `make prepare_test_binaries community=true ver=v7.0.0 os=linux arch=amd64`. (The `community=true` option is necessary when you need to specify a version, arch or whatever.)
   ...
   * [minio](https://github.com/minio/minio)
   ...
   > You could download these binaries by yourself from [tidb-community-toolkit](https://download.pingcap.com/tidb-community-toolkit-v8.5.0-linux-amd64.tar.gz) and [tidb-community-server](https://download.pingcap.com/tidb-community-server-v8.5.0-linux-amd64.tar.gz).
