...
function run() {
	...
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/sink/ddlsink/mysql/MySQLSinkExecDDLDelay=return(true);github.com/pingcap/ticdc/pkg/sink/mysql/mysql_writer_ddl/MySQLSinkExecDDLDelay=return(true)'
