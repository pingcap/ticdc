...
mysql_groups=(
	# G00
	'generate_column many_pk_or_uk multi_source consistent_ddl_for_split_tables_with_failover'
	# G01
	...
	# G03
	'consistent_ddl_for_split_tables_with_merge_and_split'
	# G04
	...
	'consistent_fail_over_ddl_mix_with_syncpoint'
)
