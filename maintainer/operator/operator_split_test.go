...
func TestSplitOperator_OriginNodeRemovedBeforeStopped(t *testing.T) {
	...
	op := NewSplitDispatcherOperator(spanController, replicaSet, splitSpans, splitTargetNodes, nil, testChecksumUpdater{})
	require.NotNil(t, op)
...
func TestSplitOperator_SuccessfulSplitCreatesAbsentSpans(t *testing.T) {
	...
	op := NewSplitDispatcherOperator(spanController, replicaSet, splitSpans, []node.ID{}, nil, testChecksumUpdater{})
	require.NotNil(t, op)
...
func TestSplitOperator_SuccessfulSplitToSchedulingTargets(t *testing.T) {
	...
	op := NewSplitDispatcherOperator(spanController, replicaSetToSplit, splitSpans, splitTargetNodes, nil, testChecksumUpdater{})
	require.NotNil(t, op)
