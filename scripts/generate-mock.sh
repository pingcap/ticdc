...
"$MOCKGEN" -destination pkg/sink/kafka/factory_mock.go -package kafka -self_package github.com/pingcap/ticdc/pkg/sink/kafka github.com/pingcap/ticdc/pkg/sink/kafka Factory,SyncProducer,AsyncProducer
