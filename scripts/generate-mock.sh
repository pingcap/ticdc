...
"$MOCKGEN" -source pkg/sink/kafka/cluster_admin_client.go -destination pkg/sink/kafka/cluster_admin_client_mock.go -package kafka -self_package github.com/pingcap/ticdc/pkg/sink/kafka
"$MOCKGEN" -source pkg/sink/kafka/factory.go -destination pkg/sink/kafka/factory_mock.go -package kafka -self_package github.com/pingcap/ticdc/pkg/sink/kafka
"$MOCKGEN" -source pkg/sink/kafka/metrics_collector.go -destination pkg/sink/kafka/metrics_collector_mock.go -package kafka -self_package github.com/pingcap/ticdc/pkg/sink/kafka
"$MOCKGEN" -source pkg/sink/kafka/admin.go -destination pkg/sink/kafka/admin_mock.go -package kafka -self_package github.com/pingcap/ticdc/pkg/sink/kafka
"$MOCKGEN" -source pkg/sink/kafka/sarama_sync_producer.go -destination pkg/sink/kafka/sarama_sync_producer_mock.go -package kafka -self_package github.com/pingcap/ticdc/pkg/sink/kafka
