...
type MaintainerStatus struct {
	...
	// drain_target_node_id is the active dispatcher drain target observed by this maintainer.
	// Empty means no active dispatcher drain target.
	DrainTargetNodeId string `protobuf:"bytes,8,opt,name=drain_target_node_id,json=drainTargetNodeId,proto3" json:"drain_target_node_id,omitempty"`
	// drain_target_epoch is the coordinator-assigned target epoch used to reject stale drain targets.
	DrainTargetEpoch uint64 `protobuf:"varint,9,opt,name=drain_target_epoch,json=drainTargetEpoch,proto3" json:"drain_target_epoch,omitempty"`
	// drain_target_dispatcher_count is the number of dispatchers still bound to drain_target_node_id.
	DrainTargetDispatcherCount uint32 `protobuf:"varint,10,opt,name=drain_target_dispatcher_count,json=drainTargetDispatcherCount,proto3" json:"drain_target_dispatcher_count,omitempty"`
}
...
func (m *MaintainerStatus) GetDrainTargetNodeId() string {
	if m != nil {
		return m.DrainTargetNodeId
	}
	return ""
}

func (m *MaintainerStatus) GetDrainTargetEpoch() uint64 {
	if m != nil {
		return m.DrainTargetEpoch
	}
	return 0
}

func (m *MaintainerStatus) GetDrainTargetDispatcherCount() uint32 {
	if m != nil {
		return m.DrainTargetDispatcherCount
	}
	return 0
}
...
var fileDescriptor_6d584080fdadb670 = []byte{
	...
	,
}
...
func (m *MaintainerStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.DrainTargetDispatcherCount != 0 {
		i = encodeVarintHeartbeat(dAtA, i, uint64(m.DrainTargetDispatcherCount))
		i--
		dAtA[i] = 0x50
	}
	if m.DrainTargetEpoch != 0 {
		i = encodeVarintHeartbeat(dAtA, i, uint64(m.DrainTargetEpoch))
		i--
		dAtA[i] = 0x48
	}
	if len(m.DrainTargetNodeId) > 0 {
		i -= len(m.DrainTargetNodeId)
		copy(dAtA[i:], m.DrainTargetNodeId)
		i = encodeVarintHeartbeat(dAtA, i, uint64(len(m.DrainTargetNodeId)))
		i--
		dAtA[i] = 0x42
	}
	if m.LastSyncedTs != 0 {
...
func (m *MaintainerStatus) Size() (n int) {
	...
	l = len(m.DrainTargetNodeId)
	if l > 0 {
		n += 1 + l + sovHeartbeat(uint64(l))
	}
	if m.DrainTargetEpoch != 0 {
		n += 1 + sovHeartbeat(uint64(m.DrainTargetEpoch))
	}
	if m.DrainTargetDispatcherCount != 0 {
		n += 1 + sovHeartbeat(uint64(m.DrainTargetDispatcherCount))
	}
	return n
}
...
func (m *MaintainerStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DrainTargetNodeId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DrainTargetNodeId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DrainTargetEpoch", wireType)
			}
			m.DrainTargetEpoch = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowHeartbeat
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DrainTargetEpoch |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DrainTargetDispatcherCount", wireType)
			}
			m.DrainTargetDispatcherCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowHeartbeat
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DrainTargetDispatcherCount |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
