...
type MaintainerStatus struct {
	...
	// maintainer_epoch fences one maintainer scheduling generation from another.
	// Coordinator must not use a status from an older epoch to finish a current add operator.
...
type AddMaintainerRequest struct {
	...
	// maintainer_epoch identifies the scheduling generation this add request belongs to.
...
type RemoveMaintainerRequest struct {
	...
	// maintainer_epoch identifies the scheduling generation this remove request belongs to.
...
type MaintainerBootstrapRequest struct {
	...
	// maintainer_epoch fences dispatcher-manager bootstrap ownership across maintainer generations.
...
type MaintainerBootstrapResponse struct {
	...
	// maintainer_epoch echoes the request generation so stale responses can be ignored.
...
type MaintainerPostBootstrapRequest struct {
	...
	// maintainer_epoch fences post-bootstrap initialization across maintainer generations.
	MaintainerEpoch uint64 `protobuf:"varint,5,opt,name=maintainer_epoch,json=maintainerEpoch,proto3" json:"maintainer_epoch,omitempty"`
}
...
type MaintainerCloseRequest struct {
	...
	// maintainer_epoch fences close requests across maintainer generations.
...
var fileDescriptor_6d584080fdadb670 = []byte{
	...
	,
}
