...
type RecoverDispatcherResponseState int32

const (
	RecoverDispatcherResponseState_UNSPECIFIED RecoverDispatcherResponseState = 0
	// ACCEPTED means maintainer accepted the request and created a restart operator.
	RecoverDispatcherResponseState_ACCEPTED RecoverDispatcherResponseState = 1
	// RUNNING means a restart operator is already in-flight for this request.
	RecoverDispatcherResponseState_RUNNING RecoverDispatcherResponseState = 2
	// SUPERSEDED means this request is no longer needed (for example replaced by another operator).
	RecoverDispatcherResponseState_SUPERSEDED RecoverDispatcherResponseState = 3
	// FAILED means maintainer cannot continue dispatcher-level recovery and downgraded to changefeed-level handling.
	RecoverDispatcherResponseState_FAILED RecoverDispatcherResponseState = 4
)

var RecoverDispatcherResponseState_name = map[int32]string{
	0: "UNSPECIFIED",
	1: "ACCEPTED",
	2: "RUNNING",
	3: "SUPERSEDED",
...
var RecoverDispatcherResponseState_value = map[string]int32{
	"UNSPECIFIED": 0,
	"ACCEPTED":    1,
	"RUNNING":     2,
	"SUPERSEDED":  3,
...
func (x RecoverDispatcherResponseState) String() string {
	return proto.EnumName(RecoverDispatcherResponseState_name, int32(x))
}

func (RecoverDispatcherResponseState) EnumDescriptor() ([]byte, []int) {
...
// RecoverDispatcherIdentity identifies one recover request identity.
type RecoverDispatcherIdentity struct {
	DispatcherID    *DispatcherID `protobuf:"bytes,1,opt,name=dispatcherID,proto3" json:"dispatcherID,omitempty"`
	DispatcherEpoch uint64        `protobuf:"varint,2,opt,name=dispatcherEpoch,proto3" json:"dispatcherEpoch,omitempty"`
	MaintainerEpoch uint64        `protobuf:"varint,3,opt,name=maintainerEpoch,proto3" json:"maintainerEpoch,omitempty"`
}

func (m *RecoverDispatcherIdentity) Reset()         { *m = RecoverDispatcherIdentity{} }
func (m *RecoverDispatcherIdentity) String() string { return proto.CompactTextString(m) }
func (*RecoverDispatcherIdentity) ProtoMessage()    {}
func (*RecoverDispatcherIdentity) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d584080fdadb670, []int{2}
}
func (m *RecoverDispatcherIdentity) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RecoverDispatcherIdentity) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RecoverDispatcherIdentity.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RecoverDispatcherIdentity) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RecoverDispatcherIdentity.Merge(m, src)
}
func (m *RecoverDispatcherIdentity) XXX_Size() int {
	return m.Size()
}
func (m *RecoverDispatcherIdentity) XXX_DiscardUnknown() {
	xxx_messageInfo_RecoverDispatcherIdentity.DiscardUnknown(m)
}

var xxx_messageInfo_RecoverDispatcherIdentity proto.InternalMessageInfo

func (m *RecoverDispatcherIdentity) GetDispatcherID() *DispatcherID {
	if m != nil {
...
func (m *RecoverDispatcherIdentity) GetDispatcherEpoch() uint64 {
	if m != nil {
		return m.DispatcherEpoch
	}
	return 0
}

func (m *RecoverDispatcherIdentity) GetMaintainerEpoch() uint64 {
	if m != nil {
...
// RecoverDispatcherRequest asks maintainer to restart specified dispatchers in-place.
// It is used for localized recovery when downstream sink hits recoverable errors.
type RecoverDispatcherRequest struct {
	ChangefeedID *ChangefeedID                `protobuf:"bytes,1,opt,name=changefeedID,proto3" json:"changefeedID,omitempty"`
	Identities   []*RecoverDispatcherIdentity `protobuf:"bytes,2,rep,name=identities,proto3" json:"identities,omitempty"`
}

func (m *RecoverDispatcherRequest) Reset()         { *m = RecoverDispatcherRequest{} }
func (m *RecoverDispatcherRequest) String() string { return proto.CompactTextString(m) }
func (*RecoverDispatcherRequest) ProtoMessage()    {}
func (*RecoverDispatcherRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d584080fdadb670, []int{3}
}
func (m *RecoverDispatcherRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RecoverDispatcherRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RecoverDispatcherRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RecoverDispatcherRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RecoverDispatcherRequest.Merge(m, src)
}
func (m *RecoverDispatcherRequest) XXX_Size() int {
	return m.Size()
}
func (m *RecoverDispatcherRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_RecoverDispatcherRequest.DiscardUnknown(m)
}

var xxx_messageInfo_RecoverDispatcherRequest proto.InternalMessageInfo

func (m *RecoverDispatcherRequest) GetChangefeedID() *ChangefeedID {
	if m != nil {
		return m.ChangefeedID
	}
	return nil
...
func (m *RecoverDispatcherRequest) GetIdentities() []*RecoverDispatcherIdentity {
	if m != nil {
		return m.Identities
	}
	return nil
...
type RecoverDispatcherResponseEntry struct {
	Identity *RecoverDispatcherIdentity     `protobuf:"bytes,1,opt,name=identity,proto3" json:"identity,omitempty"`
	State    RecoverDispatcherResponseState `protobuf:"varint,2,opt,name=state,proto3,enum=heartbeatpb.RecoverDispatcherResponseState" json:"state,omitempty"`
}

func (m *RecoverDispatcherResponseEntry) Reset()         { *m = RecoverDispatcherResponseEntry{} }
func (m *RecoverDispatcherResponseEntry) String() string { return proto.CompactTextString(m) }
func (*RecoverDispatcherResponseEntry) ProtoMessage()    {}
func (*RecoverDispatcherResponseEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d584080fdadb670, []int{4}
}
func (m *RecoverDispatcherResponseEntry) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RecoverDispatcherResponseEntry) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RecoverDispatcherResponseEntry.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RecoverDispatcherResponseEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RecoverDispatcherResponseEntry.Merge(m, src)
}
func (m *RecoverDispatcherResponseEntry) XXX_Size() int {
	return m.Size()
}
func (m *RecoverDispatcherResponseEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_RecoverDispatcherResponseEntry.DiscardUnknown(m)
}

var xxx_messageInfo_RecoverDispatcherResponseEntry proto.InternalMessageInfo

func (m *RecoverDispatcherResponseEntry) GetIdentity() *RecoverDispatcherIdentity {
	if m != nil {
		return m.Identity
	}
	return nil
...
func (m *RecoverDispatcherResponseEntry) GetState() RecoverDispatcherResponseState {
	if m != nil {
		return m.State
	}
	return RecoverDispatcherResponseState_UNSPECIFIED
}

type RecoverDispatcherResponse struct {
	ChangefeedID *ChangefeedID                     `protobuf:"bytes,1,opt,name=changefeedID,proto3" json:"changefeedID,omitempty"`
	Entries      []*RecoverDispatcherResponseEntry `protobuf:"bytes,2,rep,name=entries,proto3" json:"entries,omitempty"`
}

func (m *RecoverDispatcherResponse) Reset()         { *m = RecoverDispatcherResponse{} }
func (m *RecoverDispatcherResponse) String() string { return proto.CompactTextString(m) }
func (*RecoverDispatcherResponse) ProtoMessage()    {}
func (*RecoverDispatcherResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d584080fdadb670, []int{5}
}
func (m *RecoverDispatcherResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RecoverDispatcherResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RecoverDispatcherResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RecoverDispatcherResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RecoverDispatcherResponse.Merge(m, src)
}
func (m *RecoverDispatcherResponse) XXX_Size() int {
	return m.Size()
}
func (m *RecoverDispatcherResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_RecoverDispatcherResponse.DiscardUnknown(m)
}

var xxx_messageInfo_RecoverDispatcherResponse proto.InternalMessageInfo

func (m *RecoverDispatcherResponse) GetChangefeedID() *ChangefeedID {
	if m != nil {
		return m.ChangefeedID
	}
	return nil
...
func (m *RecoverDispatcherResponse) GetEntries() []*RecoverDispatcherResponseEntry {
	if m != nil {
		return m.Entries
	}
	return nil
...
func init() {
	proto.RegisterEnum("heartbeatpb.RecoverDispatcherResponseState", RecoverDispatcherResponseState_name, RecoverDispatcherResponseState_value)
	...
	proto.RegisterType((*RecoverDispatcherIdentity)(nil), "heartbeatpb.RecoverDispatcherIdentity")
	proto.RegisterType((*RecoverDispatcherRequest)(nil), "heartbeatpb.RecoverDispatcherRequest")
	proto.RegisterType((*RecoverDispatcherResponseEntry)(nil), "heartbeatpb.RecoverDispatcherResponseEntry")
	proto.RegisterType((*RecoverDispatcherResponse)(nil), "heartbeatpb.RecoverDispatcherResponse")
...
var fileDescriptor_6d584080fdadb670 = []byte{
	...
	,
}
...
func (m *RecoverDispatcherIdentity) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RecoverDispatcherIdentity) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RecoverDispatcherIdentity) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.DispatcherEpoch != 0 {
		i = encodeVarintHeartbeat(dAtA, i, uint64(m.DispatcherEpoch))
		i--
		dAtA[i] = 0x10
	}
...
func (m *RecoverDispatcherRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RecoverDispatcherRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RecoverDispatcherRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RecoverDispatcherResponseEntry) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RecoverDispatcherResponseEntry) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RecoverDispatcherResponseEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RecoverDispatcherResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RecoverDispatcherResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RecoverDispatcherResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RecoverDispatcherIdentity) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.DispatcherEpoch != 0 {
		n += 1 + sovHeartbeat(uint64(m.DispatcherEpoch))
	}
	if m.MaintainerEpoch != 0 {
...
func (m *RecoverDispatcherRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RecoverDispatcherResponseEntry) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RecoverDispatcherResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RecoverDispatcherIdentity) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RecoverDispatcherIdentity: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RecoverDispatcherIdentity: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DispatcherEpoch", wireType)
			}
			m.DispatcherEpoch = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DispatcherEpoch |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *RecoverDispatcherRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RecoverDispatcherRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RecoverDispatcherRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Identities = append(m.Identities, &RecoverDispatcherIdentity{})
...
func (m *RecoverDispatcherResponseEntry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RecoverDispatcherResponseEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RecoverDispatcherResponseEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Identity == nil {
				m.Identity = &RecoverDispatcherIdentity{}
			}
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= RecoverDispatcherResponseState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *RecoverDispatcherResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RecoverDispatcherResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RecoverDispatcherResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Entries = append(m.Entries, &RecoverDispatcherResponseEntry{})
