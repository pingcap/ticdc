...
// NodeResourceUsageStatus distinguishes rolling-upgrade compatibility from a
// telemetry interruption on nodes that have declared support for reporting.
type NodeResourceUsageStatus int32

const (
	NodeResourceUsageStatus_UNSUPPORTED NodeResourceUsageStatus = 0
	NodeResourceUsageStatus_INCOMPLETE  NodeResourceUsageStatus = 1
	NodeResourceUsageStatus_AVAILABLE   NodeResourceUsageStatus = 2
)

var NodeResourceUsageStatus_name = map[int32]string{
	0: "UNSUPPORTED",
	1: "INCOMPLETE",
	2: "AVAILABLE",
}

var NodeResourceUsageStatus_value = map[string]int32{
	"UNSUPPORTED": 0,
	"INCOMPLETE":  1,
	"AVAILABLE":   2,
}

func (x NodeResourceUsageStatus) String() string {
	return proto.EnumName(NodeResourceUsageStatus_name, int32(x))
}

func (NodeResourceUsageStatus) EnumDescriptor() ([]byte, []int) {
...
type NodeHeartbeat struct {
	...
	NodeResourceUsage                *NodeResourceUsage    `protobuf:"bytes,8,opt,name=node_resource_usage,json=nodeResourceUsage,proto3" json:"node_resource_usage,omitempty"`
	NodeResourceUsageProtocolVersion uint32                `protobuf:"varint,9,opt,name=node_resource_usage_protocol_version,json=nodeResourceUsageProtocolVersion,proto3" json:"node_resource_usage_protocol_version,omitempty"`
}
...
func (m *NodeHeartbeat) GetNodeResourceUsage() *NodeResourceUsage {
	if m != nil {
		return m.NodeResourceUsage
	}
	return nil
}

func (m *NodeHeartbeat) GetNodeResourceUsageProtocolVersion() uint32 {
	if m != nil {
...
type NodeHeartbeatResponse struct {
	...
	NodeResourceUsages      []*NodeResourceUsage        `protobuf:"bytes,6,rep,name=node_resource_usages,json=nodeResourceUsages,proto3" json:"node_resource_usages,omitempty"`
	NodeResourceUsageStatus NodeResourceUsageStatus     `protobuf:"varint,7,opt,name=node_resource_usage_status,json=nodeResourceUsageStatus,proto3,enum=heartbeatpb.NodeResourceUsageStatus" json:"node_resource_usage_status,omitempty"`
}
...
func (m *NodeHeartbeatResponse) GetNodeResourceUsages() []*NodeResourceUsage {
	if m != nil {
		return m.NodeResourceUsages
	}
	return nil
}

func (m *NodeHeartbeatResponse) GetNodeResourceUsageStatus() NodeResourceUsageStatus {
	if m != nil {
		return m.NodeResourceUsageStatus
	}
	return NodeResourceUsageStatus_UNSUPPORTED
}
...
// NodeResourceUsage carries node-wide EventStore resource usage. Node heartbeat
// requests report the cumulative counter; coordinator responses set node_id and
// the derived rate for every entry in the cluster snapshot.
type NodeResourceUsage struct {
	// Set by node heartbeat requests.
	EventStoreWriteBytes uint64 `protobuf:"varint,1,opt,name=event_store_write_bytes,json=eventStoreWriteBytes,proto3" json:"event_store_write_bytes,omitempty"`
	// Set by coordinator heartbeat responses.
	NodeId string `protobuf:"bytes,2,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	// Set by coordinator heartbeat responses.
	EventStoreWriteBytesPerSecond uint64 `protobuf:"varint,3,opt,name=event_store_write_bytes_per_second,json=eventStoreWriteBytesPerSecond,proto3" json:"event_store_write_bytes_per_second,omitempty"`
}

func (m *NodeResourceUsage) Reset()         { *m = NodeResourceUsage{} }
func (m *NodeResourceUsage) String() string { return proto.CompactTextString(m) }
func (*NodeResourceUsage) ProtoMessage()    {}
func (*NodeResourceUsage) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d584080fdadb670, []int{56}
}
func (m *NodeResourceUsage) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NodeResourceUsage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NodeResourceUsage.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *NodeResourceUsage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NodeResourceUsage.Merge(m, src)
}
func (m *NodeResourceUsage) XXX_Size() int {
	return m.Size()
}
func (m *NodeResourceUsage) XXX_DiscardUnknown() {
	xxx_messageInfo_NodeResourceUsage.DiscardUnknown(m)
}

var xxx_messageInfo_NodeResourceUsage proto.InternalMessageInfo

func (m *NodeResourceUsage) GetEventStoreWriteBytes() uint64 {
	if m != nil {
...
func (m *NodeResourceUsage) GetNodeId() string {
	if m != nil {
		return m.NodeId
	}
	return ""
...
func (m *NodeResourceUsage) GetEventStoreWriteBytesPerSecond() uint64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterEnum("heartbeatpb.NodeResourceUsageStatus", NodeResourceUsageStatus_name, NodeResourceUsageStatus_value)
	...
	proto.RegisterType((*NodeResourceUsage)(nil), "heartbeatpb.NodeResourceUsage")
}
...
var fileDescriptor_6d584080fdadb670 = []byte{
	...
	,
}
...
func (m *NodeHeartbeat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.NodeResourceUsageProtocolVersion != 0 {
		i = encodeVarintHeartbeat(dAtA, i, uint64(m.NodeResourceUsageProtocolVersion))
		i--
		dAtA[i] = 0x48
	}
	if m.NodeResourceUsage != nil {
		{
			size, err := m.NodeResourceUsage.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *NodeHeartbeatResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.NodeResourceUsageStatus != 0 {
		i = encodeVarintHeartbeat(dAtA, i, uint64(m.NodeResourceUsageStatus))
		i--
		dAtA[i] = 0x38
	}
	if len(m.NodeResourceUsages) > 0 {
		for iNdEx := len(m.NodeResourceUsages) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.NodeResourceUsages[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *InfluencedTables) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TableIDs) > 0 {
		...
		i = encodeVarintHeartbeat(dAtA, i, uint64(j43))
		i--
		dAtA[i] = 0x12
	}
	if m.InfluenceType != 0 {
...
func (m *NodeResourceUsage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NodeResourceUsage) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NodeResourceUsage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.EventStoreWriteBytesPerSecond != 0 {
		i = encodeVarintHeartbeat(dAtA, i, uint64(m.EventStoreWriteBytesPerSecond))
		i--
		dAtA[i] = 0x18
	}
	if len(m.NodeId) > 0 {
		...
		i = encodeVarintHeartbeat(dAtA, i, uint64(len(m.NodeId)))
		i--
		dAtA[i] = 0x12
	}
	if m.EventStoreWriteBytes != 0 {
		i = encodeVarintHeartbeat(dAtA, i, uint64(m.EventStoreWriteBytes))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *NodeHeartbeat) Size() (n int) {
	...
	if m.NodeResourceUsage != nil {
		l = m.NodeResourceUsage.Size()
		n += 1 + l + sovHeartbeat(uint64(l))
	}
	if m.NodeResourceUsageProtocolVersion != 0 {
		n += 1 + sovHeartbeat(uint64(m.NodeResourceUsageProtocolVersion))
	}
	return n
}
...
func (m *NodeHeartbeatResponse) Size() (n int) {
	...
	if len(m.NodeResourceUsages) > 0 {
		for _, e := range m.NodeResourceUsages {
			l = e.Size()
			n += 1 + l + sovHeartbeat(uint64(l))
		}
	}
	if m.NodeResourceUsageStatus != 0 {
		n += 1 + sovHeartbeat(uint64(m.NodeResourceUsageStatus))
	}
	return n
}
...
func (m *NodeResourceUsage) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.EventStoreWriteBytes != 0 {
		n += 1 + sovHeartbeat(uint64(m.EventStoreWriteBytes))
	}
	l = len(m.NodeId)
	if l > 0 {
		n += 1 + l + sovHeartbeat(uint64(l))
	...
	if m.EventStoreWriteBytesPerSecond != 0 {
		n += 1 + sovHeartbeat(uint64(m.EventStoreWriteBytesPerSecond))
	}
	return n
}
...
func (m *NodeHeartbeat) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NodeResourceUsage", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.NodeResourceUsage == nil {
				m.NodeResourceUsage = &NodeResourceUsage{}
			}
			if err := m.NodeResourceUsage.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NodeResourceUsageProtocolVersion", wireType)
			}
			m.NodeResourceUsageProtocolVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowHeartbeat
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NodeResourceUsageProtocolVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *NodeHeartbeatResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NodeResourceUsages", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NodeResourceUsages = append(m.NodeResourceUsages, &NodeResourceUsage{})
			if err := m.NodeResourceUsages[len(m.NodeResourceUsages)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NodeResourceUsageStatus", wireType)
			}
			m.NodeResourceUsageStatus = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowHeartbeat
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NodeResourceUsageStatus |= NodeResourceUsageStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *NodeResourceUsage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NodeResourceUsage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NodeResourceUsage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EventStoreWriteBytes", wireType)
			}
			m.EventStoreWriteBytes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowHeartbeat
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EventStoreWriteBytes |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EventStoreWriteBytesPerSecond", wireType)
			}
			m.EventStoreWriteBytesPerSecond = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowHeartbeat
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EventStoreWriteBytesPerSecond |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
