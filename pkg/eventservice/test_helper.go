...
func (m *mockSchemaStore) FetchTableTriggerDDLEvents(keyspaceID uint32, dispatcherID common.DispatcherID, tableFilter filter.Filter, start uint64) ([]commonEvent.DDLEvent, uint64, error) {
	return nil, 0, nil
}
