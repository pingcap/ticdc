...
=======
	status1 := newChangefeedStatus(info1.GetChangefeedID(), info1.GetSyncPointInterval())
>>>>>>> 2e6aabd14 (*:improve memory control (#4030))
...
=======
	status2 := newChangefeedStatus(info2.GetChangefeedID(), info2.GetSyncPointInterval())
>>>>>>> 2e6aabd14 (*:improve memory control (#4030))
