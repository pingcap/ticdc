...
func NewClientWithContext(
	ctx context.Context, component Component, svrAddrs []string,
	security pdopt.SecurityOption, opts ...pdopt.ClientOption,
) (pdopt.Client, error) {
	return pdopt.NewClientWithContext(ctx, svrAddrs, security, opts...)
}
