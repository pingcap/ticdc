...
func BenchmarkMap(b *testing.B) {
	...
	for i := 0; i < len(spans); i++ {
		spans[i] = common.TableIDToComparableSpan(common.DefaultKeyspaceID, int64(i))
	}
	...
	bench := func(name string, benchBm, benchSm func(i int)) {
	...
	start, end := spans[0], common.TableIDToComparableSpan(common.DefaultKeyspaceID, int64(len(spans)))
