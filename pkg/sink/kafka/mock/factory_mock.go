...
import (
	...
	kafka "github.com/pingcap/ticdc/pkg/sink/kafka"
)
...
func (m *MockFactory) AdminClient(ctx context.Context) (kafka.ClusterAdminClient, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AdminClient", ctx)
	ret0, _ := ret[0].(kafka.ClusterAdminClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockFactory) AsyncProducer(ctx context.Context) (kafka.AsyncProducer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AsyncProducer", ctx)
	ret0, _ := ret[0].(kafka.AsyncProducer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockFactory) MetricsCollector(adminClient kafka.ClusterAdminClient) kafka.MetricsCollector {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MetricsCollector", adminClient)
	ret0, _ := ret[0].(kafka.MetricsCollector)
	return ret0
}
...
func (m *MockFactory) SyncProducer(ctx context.Context) (kafka.SyncProducer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SyncProducer", ctx)
	ret0, _ := ret[0].(kafka.SyncProducer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
