...
func (m *messageKey) Decode(data []byte) {
	...
	if err != nil {
		log.Panic("decode message key failed", zap.String("data", redact.Any(data)), zap.Error(err))
	}
}
...
func formatColumn(c column, ft types.FieldType) column {
	...
	case mysql.TypeString, mysql.TypeVarString, mysql.TypeVarchar:
		...
		case string:
			if isBinary(c.Flag) {
				...
				if err != nil {
					log.Panic("invalid column value, please report a bug", zap.String("value", redact.Value(fmt.Sprintf("%v", data))), zap.Error(err))
				}
			}
			data = []byte(v)
		default:
			log.Panic("invalid column value, please report a bug", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Any("type", v))
		}
		c.Value = data
	...
	case mysql.TypeYear:
		...
		default:
			log.Panic("invalid column value for year", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Any("type", v))
		}
		if err != nil {
			log.Panic("invalid column value for year", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Error(err))
		}
		c.Value = value
	case mysql.TypeDate, mysql.TypeDatetime, mysql.TypeTimestamp:
		...
		case string:
			data = v
		default:
			log.Panic("invalid column value for date / datetime / timestamp", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Any("type", v))
		}
		c.Value, err = tiTypes.ParseTime(tiTypes.DefaultStmtNoWarningContext, data, ft.GetType(), ft.GetDecimal())
		if err != nil {
			log.Panic("invalid column value for date / datetime / timestamp", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Error(err))
		}
	...
	case mysql.TypeDuration:
		...
		case string:
			data = v
		default:
			log.Panic("invalid column value for duration", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Any("type", v))
		}
		c.Value, _, err = tiTypes.ParseDuration(tiTypes.DefaultStmtNoWarningContext, data, ft.GetDecimal())
		if err != nil {
			log.Panic("invalid column value for duration", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Error(err))
		}
	case mysql.TypeBit:
		var intVal uint64
		switch v := c.Value.(type) {
		...
		case json.Number:
			a, err := v.Int64()
			if err != nil {
				log.Panic("invalid column value for the bit type", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Error(err))
			}
			intVal = uint64(a)
		default:
			log.Panic("invalid column value for the bit type", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Any("type", v))
		}
	...
	case mysql.TypeEnum:
		...
		default:
			log.Panic("invalid column value for enum", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Any("type", v))
		}
		if err != nil {
			log.Panic("invalid column value for enum", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Error(err))
		}
	...
	case mysql.TypeSet:
		...
		default:
			log.Panic("invalid column value for set", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Any("type", v))
		}
		if err != nil {
			log.Panic("invalid column value for set", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Error(err))
		}
	...
	case mysql.TypeJSON:
		...
		case string:
			data = v
		default:
			log.Panic("invalid column value for JSON", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Any("type", v))
		}
		c.Value, err = tiTypes.ParseBinaryJSONFromString(data)
		if err != nil {
			log.Panic("invalid column value for json", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Error(err))
		}
	case mysql.TypeNewDecimal:
		...
		case string:
			data = []byte(v)
		default:
			log.Panic("invalid column value for decimal", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Any("type", v))
		}
		dec := new(tiTypes.MyDecimal)
		err = dec.FromString(data)
		if err != nil {
			log.Panic("invalid column value for decimal", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Error(err))
		}
		c.Value = dec
	case mysql.TypeTiDBVectorFloat32:
		...
		case string:
			data = v
		default:
			log.Panic("invalid column value for vector float32", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Any("type", v))
		}
		c.Value, err = tiTypes.ParseVectorFloat32(data)
		if err != nil {
			log.Panic("invalid column value for vector float32", zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))), zap.Error(err))
		}
	default:
		log.Panic("unknown data type found", zap.Any("type", c.Type), zap.String("value", redact.Value(fmt.Sprintf("%v", c.Value))))
	}
	return c
}
...
func (m *messageRow) decode(data []byte) {
	...
	if err != nil {
		log.Panic("decode message row failed", zap.String("data", redact.Any(data)), zap.Error(err))
	}
}
