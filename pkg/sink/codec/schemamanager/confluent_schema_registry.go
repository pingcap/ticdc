...
<<<<<<< HEAD:pkg/sink/codec/avro/confluent_schema_registry.go
...
>>>>>>> fb743a814 (sink: Make ddl and dml encoders share schema manager (#6100)):pkg/sink/codec/schemamanager/confluent_schema_registry.go
