...
func (z *LatestTableNameChanges) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z LatestTableNameChanges) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 0
	err = en.Append(0x80)
	if err != nil {
		return
...
func (z LatestTableNameChanges) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *LatestTableNameChanges) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z LatestTableNameChanges) Msgsize() (s int) {
	s = 1
	return
}
