...
func NewReadyEvent(dispatcherID common.DispatcherID, incarnation uint64) ReadyEvent {
	return ReadyEvent{
...
func (e *ReadyEvent) String() string {
	return fmt.Sprintf("ReadyEvent{Version: %d, DispatcherID: %s, Incarnation: %d}", e.Version, e.DispatcherID, e.Incarnation)
}
