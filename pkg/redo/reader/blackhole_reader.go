...
func (br *BlackHoleReader) ReadNextRow(ctx context.Context) (*pevent.DMLEvent, bool, error) {
	return &pevent.DMLEvent{}, false, nil
}

// ReadNextDDL implements LogReader.ReadNextDDL
func (br *BlackHoleReader) ReadNextDDL(ctx context.Context) (*pevent.DDLEvent, bool, error) {
	return &pevent.DDLEvent{}, false, nil
}
