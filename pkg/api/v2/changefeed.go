...
type ChangefeedInterface interface {
	...
	MoveTable(ctx context.Context, namespace string, name string, tableID int64, targetNode string, consistent bool) error
	// Move dispatchers in a split Table to target node, it just for make test case now. **Not for public use.**
	MoveSplitTable(ctx context.Context, namespace string, name string, tableID int64, targetNode string, consistent bool) error
	// split table based on region count, it just for make test case now. **Not for public use.**
	SplitTableByRegionCount(ctx context.Context, namespace string, name string, tableID int64, consistent bool) error
	// merge table, it just for make test case now. **Not for public use.**
	MergeTable(ctx context.Context, namespace string, name string, tableID int64, consistent bool) error
}
...
func (c *changefeeds) MoveTable(ctx context.Context,
	namespace string, name string, tableID int64, targetNode string, consistent bool,
) error {
	...
	err := c.client.Post().
		...
		WithParam("consistent", strconv.FormatBool(consistent)).
		Do(ctx).Error()
	return err
}
...
func (c *changefeeds) SplitTableByRegionCount(ctx context.Context,
	namespace string, name string, tableID int64, consistent bool,
) error {
