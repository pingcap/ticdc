...
type DispatcherRequest struct {
	...
	// enable_scan_window controls whether the event service applies the adaptive
	// scan window (memory control + scan interval) for this changefeed.
	// It defaults to false so the feature behaves as if it was never introduced.
	EnableScanWindow bool `protobuf:"varint,20,opt,name=enable_scan_window,json=enableScanWindow,proto3" json:"enable_scan_window,omitempty"`
}
...
func (m *DispatcherRequest) GetEnableScanWindow() bool {
	if m != nil {
...
var fileDescriptor_d7fb2554dfcf7f7d = []byte{
	...
	,
}
...
func (m *DispatcherRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableScanWindow", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
