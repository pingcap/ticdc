...
type InnerFilterConfig struct {
	...
	SchemaStoreIgnoreDdlTypes []string           `protobuf:"bytes,4,rep,name=schema_store_ignore_ddl_types,json=schemaStoreIgnoreDdlTypes,proto3" json:"schema_store_ignore_ddl_types,omitempty"`
}
...
func (m *InnerFilterConfig) GetSchemaStoreIgnoreDdlTypes() []string {
	if m != nil {
		return m.SchemaStoreIgnoreDdlTypes
	}
	return nil
}
...
var fileDescriptor_d7fb2554dfcf7f7d = []byte{
	...
	,
}
...
func (m *InnerFilterConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SchemaStoreIgnoreDdlTypes) > 0 {
		for iNdEx := len(m.SchemaStoreIgnoreDdlTypes) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.SchemaStoreIgnoreDdlTypes[iNdEx])
			copy(dAtA[i:], m.SchemaStoreIgnoreDdlTypes[iNdEx])
			i = encodeVarintEvent(dAtA, i, uint64(len(m.SchemaStoreIgnoreDdlTypes[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *InnerFilterConfig) Size() (n int) {
	...
	if len(m.SchemaStoreIgnoreDdlTypes) > 0 {
		for _, s := range m.SchemaStoreIgnoreDdlTypes {
			l = len(s)
			n += 1 + l + sovEvent(uint64(l))
		}
	}
...
func (m *InnerFilterConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SchemaStoreIgnoreDdlTypes", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SchemaStoreIgnoreDdlTypes = append(m.SchemaStoreIgnoreDdlTypes, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvent(dAtA[iNdEx:])
